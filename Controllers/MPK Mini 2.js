// This file implements functionality for the MPK Mini 2 controller.

// Adapted from MPK Mini 3 script by mangtronix
//
// This script causes notes, CCs, etc to only be sent to the focused / visible
// instances of Atom
 ...
 */
const INPUTS = ["MPK Mini Mk II"];

/**
 * The ports on the device to send MIDI to.
 */
const OUTPUTS = ["MPK Mini Mk II"];
